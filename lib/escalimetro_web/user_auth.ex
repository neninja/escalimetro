defmodule EscalimetroWeb.UserAuth do
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      EscalimetroWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule EscalimetroWeb.PageLive do
        use EscalimetroWeb, :live_view

        on_mount {EscalimetroWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{EscalimetroWeb.UserAuth, :require_authenticated}] do
